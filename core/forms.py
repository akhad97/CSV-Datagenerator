...
class SchemeForm(forms.ModelForm):
    class Meta:
        model = Scheme
        fields = [
            'name', 'col_name1', 'col_name2', 'col_name3', 'col_name4', 'col_name5', 'col_name6',
            'type1', 'type2', 'type3', 'type4', 'type5', 'type6',
            'order1', 'order2', 'order3', 'order4', 'order5', 'order6', 'rows',
        ]
        labels = {
            'name': 'Name',  'rows':'Rows', 'col_name1': 'Column Name', 'col_name2': 'Column Name', 'col_name3':'Column Name',
